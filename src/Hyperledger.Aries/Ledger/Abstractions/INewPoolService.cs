...
namespace Hyperledger.Aries.Contracts
{
    ...
    /// Pool service.
    /// </summary>
    public interface INewPoolService
    {
        /// <summary>
        ...
        /// </returns>
        Task<IntPtr> GetPoolAsync(string poolName, int protocolVersion);

        /// <summary>
        /// Opens the pool configuration with the specified name.
        /// </summary>
        /// <returns>The pool handle async.</returns>
        /// <param name="poolName">Pool name.</param>
        Task<IntPtr> GetPoolAsync(string poolName);
