...
namespace Hyperledger.Aries.Contracts
{
    ...
    /// Ledger service.
    /// </summary>
    public interface INewLedgerService
    {
        /// <summary>
        ...
        /// The schema async.
        /// </returns>
        Task<SharedRsResponse> LookupSchemaAsync(IAgentContext agentContext, string schemaId);
        ...
        /// </returns>
        Task<SharedRsResponse> LookupDefinitionAsync(IAgentContext agentContext, string definitionId);
        ...
        /// <returns></returns>
        Task<SharedRsResponse> LookupRevocationRegistryDefinitionAsync(IAgentContext agentContext, string registryId);
        ...
        /// </returns>
        Task<SharedRsRegistryResponse> LookupRevocationRegistryDeltaAsync(IAgentContext agentContext, string revocationRegistryId,
            long from, long to);
        ...
        /// </returns>
        Task<SharedRsRegistryResponse> LookupRevocationRegistryAsync(IAgentContext agentContext, string revocationRegistryId,
            long timestamp);
