...
namespace Hyperledger.Aries.Features.Handshakes.Connection
{
    ...
    /// Connection Service.
    /// </summary>
    public interface INewConnectionService
    {
        /// <summary>
        /// Gets the async.
        /// </summary>
        ...
        Task<ConnectionRecord> GetAsync(INewAgentContext agentContext, string connectionId);
        ...
        Task<List<ConnectionRecord>> ListAsync(INewAgentContext agentContext, ISearchQuery query = null, int count = 100, int skip = 0);
        ...
        /// <returns>The async.</returns>
        Task<(ConnectionInvitationMessage, ConnectionRecord)> CreateInvitationAsync(INewAgentContext agentContext, InviteConfiguration config = null);
        ...
        /// <returns>The async.</returns>
        Task RevokeInvitationAsync(INewAgentContext agentContext, string invitationId);
        ...
        Task<ConnectionRecord> ProcessInvitationAsync(INewAgentContext agentContext, ConnectionInvitationMessage offer);
        ...
        Task<ConnectionRecord> ProcessInvitationAsync(INewAgentContext agentContext, InvitationMessage invitation);
        ...
        Task<(ConnectionRequestMessage, ConnectionRecord)> CreateRequestAsync(INewAgentContext agentContext, ConnectionRecord connectionRecord);
        ...
        Task<(ConnectionRequestMessage, ConnectionRecord)> CreateRequestAsync(INewAgentContext agentContext, ConnectionInvitationMessage offer);
        ...
        Task<string> ProcessRequestAsync(INewAgentContext agentContext, ConnectionRequestMessage request, ConnectionRecord connection);
        ...
        Task<(ConnectionResponseMessage, ConnectionRecord)> CreateResponseAsync(INewAgentContext agentContext, string connectionId);
        ...
        /// <param name="connection">Connection.</param>
        /// <returns>Connection identifier this request is related to.</returns>
        Task<string> ProcessResponseAsync(INewAgentContext agentContext, ConnectionResponseMessage response, ConnectionRecord connection);
        ...
        Task<bool> DeleteAsync(INewAgentContext agentContext, string connectionId);
        ...
        Task<ConnectionAcknowledgeMessage> CreateAcknowledgementMessageAsync(INewAgentContext agentContext, string connectionRecordId, string status = AcknowledgementStatusConstants.Ok);
        ...
        Task<ConnectionRecord> ProcessAcknowledgementMessageAsync(INewAgentContext agentContext, ConnectionAcknowledgeMessage connectionAcknowledgeMessage);
        ...
        Task<ConnectionRecord> ResolveByMyKeyAsync(INewAgentContext agentContext, string myKey);
    }
}
