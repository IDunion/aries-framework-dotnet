...
namespace Hyperledger.Aries.Features.IssueCredential
{
    ...
    /// Credential Service
    /// </summary>
    public interface INewCredentialService
    {
        /// <summary>
        ...
        Task<CredentialRecord> GetAsync(INewAgentContext agentContext, string credentialId);
        ...
        Task<List<CredentialRecord>> ListAsync(INewAgentContext agentContext, ISearchQuery query = null, int count = 100, int skip = 0);
        ...
        Task<string> ProcessOfferAsync(INewAgentContext agentContext, CredentialOfferMessage credentialOffer,
        ...
        Task<(CredentialRequestMessage, CredentialRecord)> CreateRequestAsync(INewAgentContext agentContext, string credentialId);
        ...
        Task<CredentialRecord> CreateCredentialAsync(INewAgentContext agentContext, CredentialOfferMessage message);
        ...
        /// <exception cref="AriesFrameworkException">Throws with ErrorCode.RecordInInvalidState.</exception>
        /// <returns>The response async.</returns>
        Task RejectOfferAsync(INewAgentContext agentContext, string offerId);
        ...
        Task<string> ProcessCredentialAsync(INewAgentContext agentContext, CredentialIssueMessage credential,
            ConnectionRecord connection);
        ...
        Task<(CredentialOfferMessage, CredentialRecord)> CreateOfferAsync(
            INewAgentContext agentContext, OfferConfiguration config, string connectionId);
        ...
        /// <returns>The offer message and the identifier. </returns>
        Task<(CredentialOfferMessage, CredentialRecord)> CreateOfferAsync(
            INewAgentContext agentContext, OfferConfiguration config);
        ...
        /// <exception cref="AriesFrameworkException">Throws with ErrorCode.RecordInInvalidState.</exception>
        /// <returns>The response async.</returns>
        Task RevokeCredentialOfferAsync(INewAgentContext agentContext, string offerId);
        ...
        /// <exception cref="AriesFrameworkException">Throws with ErrorCode.RecordNotFound.</exception>
        /// <returns>The credential identifier of the stored credential record.</returns>
        Task<string> ProcessCredentialRequestAsync(INewAgentContext agentContext,
        ...
        /// <param name="credentialId">The credential identifier.</param>
        /// <returns>The response async.</returns>
        Task<(CredentialIssueMessage, CredentialRecord)> CreateCredentialAsync(INewAgentContext agentContext, string credentialId);
        ...
        /// <exception cref="AriesFrameworkException">Throws with ErrorCode.RecordNotFound.</exception>
        /// <returns>The response async.</returns>
        Task RejectCredentialRequestAsync(INewAgentContext agentContext, string credentialId);
        ...
        /// <returns>The response async.</returns>
        Task RevokeCredentialAsync(INewAgentContext agentContext, string credentialId, bool sendRevocationNotification = false);
        ...
        /// <returns></returns>
        Task DeleteCredentialAsync(INewAgentContext agentContext, string credentialId);
        ...
        Task<CredentialAcknowledgeMessage> CreateAcknowledgementMessageAsync(INewAgentContext agentContext, string credentialRecordId, string status = AcknowledgementStatusConstants.Ok);
        ...
        Task<CredentialRecord> ProcessAcknowledgementMessageAsync(INewAgentContext agentContext, CredentialAcknowledgeMessage credentialAcknowledgeMessage);
    }
}
