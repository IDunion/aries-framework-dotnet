...
namespace Hyperledger.Aries.Agents
{
    ...
    public interface INewMessageService
    {
        ...
        Task SendAsync(INewAgentContext agentContext, AgentMessage message, string recipientKey,
        ...
        /// <returns></returns>
        Task<MessageContext> SendReceiveAsync(INewAgentContext agentContext, AgentMessage message, string recipientKey,
