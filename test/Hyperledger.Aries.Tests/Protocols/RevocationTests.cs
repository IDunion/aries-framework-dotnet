...
namespace Hyperledger.Aries.Tests.Protocols
{
    ...
    public class RevocationTestsFixtureV2 : TestSingleWalletV2
    {
    ...
    public class RevocationTestsV2 : IClassFixture<RevocationTestsFixtureV2>, IAsyncLifetime
    {
        private readonly RevocationTestsFixtureV2 _fixture;
        private readonly uint _now = (uint)DateTimeOffset.Now.ToUnixTimeSeconds();

        public RevocationTestsV2(RevocationTestsFixtureV2 data)
        {
            _fixture = data;
        }
